...
//
//class WordVectors{
//    private final Map<String,List<Integer>> dict;
//    private List<String> loadedWords;
//
//    private static final List<Integer> NEUTRAL = Arrays.asList(5,5,5,5,5);
//
//    public WordVectors(String[] words, List<List<Integer>> vectors){
//        dict = new HashMap<>();
//        for(int i = 0; i < words.length; i++){
//            dict.put(words[i],new ArrayList<>(vectors.get(i)));
//        }
//        loadedWords = new ArrayList<>();
//    }
//
//    public void readWords(List<String> words){
//        this.loadedWords = new ArrayList<>(words);
//    }
//}
//
