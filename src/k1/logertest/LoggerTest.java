...
class LogSystem<T extends ILog & Comparable<T>>{
    ...
    void printResults(){
        ...
        firstLogProcessor.processLogs(elements).forEach(l -> System.out.println(l.toString()));

        System.out.println("RESULTS FROM THE SECOND LOG PROCESSOR");
        secondLogProcessor.processLogs(elements).forEach(l -> System.out.println(l.toString()));

        System.out.println("RESULTS FROM THE THIRD LOG PROCESSOR");
        thirdLogProcessor.processLogs(elements).forEach(l -> System.out.println(l.toString()));
