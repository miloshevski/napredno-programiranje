...
//    double bonus;
//
//    public HourlyEmployee(String ID, String level, double rate, double hours,String bonus) {
//        super(ID, level, rate);
//        this.hours = hours;
...
//    double bonus;
//
//    public FreelanceEmployee(String ID, String level, double rate, List<Integer> ticketPoints,double bonus) {
//        super(ID, level, rate);
...
//        String bonus = parts[1];
//
//        String type = info[0];
//        String name = info[1];
//        String level = info[2];
//        if(type.equals("H")){
//            double hours = Double.parseDouble(info[3]);
//            double rate = hourlyRate.get(level);
//            return new HourlyEmployee(name,level,rate,hours,bonus);
//        }
//    }
//}
//
